                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ url('/update-customer/'.$cus->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="shopname" value="{{ $cus->shopname }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword17">Account Holder</label>
                                    <input type="text" class="form-control" name="account_holder" value="{{ $cus->account_holder }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword41">Account Number</label>
                                    <input type="text" class="form-control" name="account_number" value="{{ $cus->account_number }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword13">Bank Name</label>
                                    <input type="text" class="form-control" name="bank_name" value="{{ $cus->bank_name }}" >
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword12">Branch Name</label>
                                    <input type="text" class="form-control" name="bank_branch" value="{{ $cus->bank_branch }}" >
                                </div>
                                <div class="form-group">
